    ...
    <div class="row">
      <div class="naviga_tion_sidebar">
        <ul class="nav nav-pills nav-stacked">
          ...
          <li class="{{ Request::segment(3) == 'calendar'?'lnk-active':''}}"><a href='{{@$result->status != ""? url("listing/$result->id/calendar"):"#"}}'><div class="radius"><span class="margin-top6">8</span></div>{{trans('messages.listing_sidebar.calender')}}</a></li>
        </ul>
      </div>
   </div>   
</div>