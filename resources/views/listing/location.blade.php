...
@section('main')
  <div class="container margin-top40 mb30">
    ...
    <form method="post" action="{{url('listing/'.$result->id.'/'.$step)}}" class='signup-form login-form' accept-charset='UTF-8'>
      <div class="col-md-9">
        <input type="hidden" name='from_place_id' value="{{ $result->property_address->from_place_id }}" id='from_place_id'>
        <input type="hidden" name='to_place_id' value="{{ $result->property_address->to_place_id }}" id='to_place_id'>
        
        <div class="row">
          <div class="col-md-8">
            <label class="label-large">{{trans('messages.listing_location.country')}}</label>
        ...
        <div class="row">
          <div class="col-md-8">
            <label class="label-large">{{trans('messages.listing_location.from')}}</label>
        ...
        <div class="row">
          <div class="col-md-8">
            <label class="label-large">{{trans('messages.listing_location.to')}}</label>
        ...
        <div class="row">
          <div class="col-md-8">
            <label class="label-large">{{trans('messages.listing_location.city_town_district')}}</label>
        ...
        <div class="row">
          <div class="col-md-8">
            <label class="label-large">{{trans('messages.listing_location.state_province')}}</label>
...
@push('scripts')
 <script>
      ...
      function AutocompleteDirectionsHandler(map) {
        this.map = map;
        this.originPlaceId = '{{ $result->property_address->from_place_id }}';
        this.destinationPlaceId = '{{ $result->property_address->to_place_id }}';
