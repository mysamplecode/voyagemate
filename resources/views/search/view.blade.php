...
<div class="container-fluid margin-top10 mb30">
  <div class="col-md-7 col-sm-8 col-xs-12 mb10 l-pad-none r-pad-none hidden-pod" style="">
    <div>
      <h5 class="col-sm-2" for="user_birthdate">{{trans('messages.search.dates')}}</h5>
      <div class="col-sm-10">
        <div class="row">
          <div class="select col-sm-4">
            <input id="search-pg-checkin" size="30" class="form-control" name="text" value="{{ $checkin }}" placeholder="{{trans('messages.search.check_in')}}" type="text">
          </div>
      
          <div class="select col-sm-4">
            <input id="search-pg-checkout" size="30" class="form-control" name="text" value="{{ $checkout }}" placeholder="{{trans('messages.search.check_out')}}"type="text">
          </div>
    ...
    <div>
      ...
      <div class="col-sm-10">
          ...
          @foreach($space_type as $row=>$value)
          <div class="col-md-4 l-pad-none">
            <div class="list-group-item" style="padding:10px 10px;">
              ...
              <label class="pull-right">
                <input type="checkbox" id="space_type_{{ $row }}" name="space_type[]" value="{{ $row }}" class="space_type" {{ in_array($row, $space_type_selected)?'checked':'' }}>
              </label>
            </div>
          </div>
          @endforeach
              ...
              if (properties.hasOwnProperty(key)) {
                room_point[key] = {
                  ...
                  content: '<a href="#" class="media-cover">'
                              +'<img style="max-height:150px;max-width:200px;" src="'+'{{url("images")}}/'+properties[key].photo_name+'" alt="">'
                            +'</a>'
