...
@section('main')
  ...
  <section class="content">
      ...
      <div class="box-body">
          ...
          <div class="row">
            <div class="col-md-8">
              <label class="label-large">{{trans('messages.listing_description.listing_name')}}</label>
              <input type="text" name="name" class="form-control" value="{{ $description->properties->name }}" placeholder="" maxlength="35">
              <span class="text-danger">{{ $errors->first('name') }}</span>
            </div>
          </div>
          <div class="row">
            <div class="col-md-8">
              <label class="label-large">{{trans('messages.listing_description.summary')}}</label>
