    ...
    <div class="panel" id="print_area">
      @if(@$bookings->count() == 0 && @$code != 1)
        <div class="panel-body">
          ...
          <a href="{{ url('/') }}/my_bookings?all=1">{{trans('messages.booking_my.booking_history')}}</a>
        </div>
      ...
      @if($code == '0' || $code == '')
        <div class="panel-body">
          <a href="{{ url('/') }}/my_bookings?all=1">{{trans('messages.booking_my.all_booking_history')}}</a>
        </div>
       @else
        <div class="panel-body">
          <a href="{{ url('/') }}/my_bookings?all=0">{{trans('messages.booking_my.upcoming_book')}}</a>
        </div>
       @endif
    @endif
    </div>
