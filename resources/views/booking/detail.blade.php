        ...
        <form accept-charset="UTF-8" action="{{ url('booking/decline/'.$booking_id) }}" id="decline_reservation_form" method="post" name="decline_reservation_form">
          <div class="modal-body">
              <div id="decline_reason_container">
                ...
                <div class="select">
                  <select class="form-control" id="decline_reason" name="decline_reason"><option value="">{{trans('messages.booking_detail.why_declining')}}</option>
                    <option value="dates_not_available">{{trans('messages.booking_detial.date_are_not_avialable')}}</option>
              ...
              <div class="col-md-12">
               ...
               {{trans('messages.booking_detail.block_calender')}}  <b>{{ $result->startdate_md }}</b> {{trans('messages.booking_details.through')}} <b>{{ $result->enddate_md }}</b>
              </div>
              <label for="cancel_message" class="row-space-top-2">
                {{trans('messages.booking_detail.optional_message_request')}}
              </label>
