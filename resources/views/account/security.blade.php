...
<div class="container margin-top30">
  <form class="{{(Auth::guard('users')->user()->password) ? 'show' : 'hide'}}" method='post' action="{{url('users/security')}}">
              ...
              <div class="panel-body">
                <div class="row">
                  <label class="text-right col-sm-3" for="user_first_name">
                    {{trans('messages.account_security.old_password')}}
                  </label>
                  <div class="col-sm-9">
                ...
                <div class="row">
                  <label class="text-right col-sm-3" for="user_first_name">
                    {{trans('messages.account_security.new_password')}}
                  </label>
                  <div class="col-sm-9">
                ...
                <div class="row">
                  <label class="text-right col-sm-3" for="user_first_name">
                    {{trans('messages.account_security.confirm_pass')}}
                  </label>
                  <div class="col-sm-9">
