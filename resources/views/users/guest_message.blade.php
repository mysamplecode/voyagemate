...
<div class="container margin-top30 mb30">
  <div class="col-md-3 col-sm-3 col-xs-12">
    ...
    <div class="col-lg-12 row margin-top20">
      <div class="col-md-6 col-sm-6 col-xs-6">
        ...
        <div class="h5">{{ date('d/m/y', strtotime($messages[0]->bookings->start_date)) }}</div>
      </div>
      <div class="col-md-6 col-sm-6 col-xs-6">
        <div class="h6"><strong>{{ trans('messages.booking_detail.check_out') }}</strong></div>
        <div class="h5">{{ date('d/m/y', strtotime($messages[0]->bookings->end_date)) }}</div>
      </div>
      <!--<div class="col-md-6 col-sm-6 col-xs-6">
    ...
    <p class="margin-top10 text-justify h6">
      <span class="text-left col-sm-6">{{ trans('messages.property_single.addtional_guest_fee') }}</span>
  ...
  <div class="col-md-9 col-sm-9 col-xs-12">
    ...
    <div class="col-lg-12 row" style="margin-left:0px;">
      <form action="{{ url('/') }}/inbox/reply/{{ $messages[0]->booking_id }}" method="post">
        ...
        <span style="float:right;"><button type="submit" class="btn ex-btn navbar-btn topbar-btn">{{ trans('messages.booking_my.send_message') }}</button></span>
      </form>
      <div class="clearfix"></div>
    </div>
    <div id="message-list">
