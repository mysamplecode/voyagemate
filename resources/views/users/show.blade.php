  ...
  <div class="col-md-9">
    ...
    <div class="profile-review">
        ...
        <div class="row margin-top20 mb25">
          <div class="col-md-3 text-center">
            <div class="media-photo-badge">
              <a href="#" ><img alt="User Profile Image" class="" src="{{ $row_host->users_from->profile_picture->src }}" title="{{ $row_host->users_from->first_name }}"></a>
              <p>{{ $row_host->users_from->first_name }}</p>
            </div>
          </div>
          <div class="col-md-9">
            <div class="row">
              <div class="col-md-6">
                  <p class="h5">{{ $row_host->comments }}</p> 
                  <p>{{ $row_host->date_fy }}</p>  
              </div>  
            </div> 
          </div>
        </div>
      ...
      <h4>{{trans('messages.users_show.review_guest')}}</h4>
        ...
        <div class="row margin-top20 mb25">
          <div class="col-md-3 text-center">
            <a href="{{ url('/') }}/users/show/{{ $row_guest->user_from }}">
              <div class="media-photo-badge">
                <img alt="User Profile Image" class="" src="{{ $row_guest->users_from->profile_picture->src }}" title="{{ $row_guest->users_from->first_name }}">
                <p>{{ $row_guest->users_from->first_name }}</p>
              </div>
            </a>
          </div>
          <div class="col-md-9">
            <div class="row">
              <div class="col-md-6">
                  <p class="h5">{{ $row_guest->comments }}</p> 
