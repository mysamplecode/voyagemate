      ...
      <div class="col-md-3">
        <div class="panel panel-default">
          ...
          <div class="text-center mb20">
            ...
            <a href="{{ url('users/profile') }}" class="btn ex-btn">{{trans('messages.users_dashboard.complete_profile')}}</a>
          </div>
        </div>
      </div>
      <div class="col-md-9">
            ...
            <ul class="list-layout">
              ...
              <li id="thread_{{ $all->id }}" class="panel-body thread-read thread">
                <div class="row">
                  ...
                  @endif
                    <div class="col-md-7">
                       <span style="color:black"><b>{{ @$all->message }}</b></span>
                      <br>
                  ...
                  <div class="col-md-2">
                    ...
                    <br>{{ $all->bookings->currency->symbol }}{{ $all->bookings->total }}</span>
                  </div>
                </div>
              </li>
              @endforeach
