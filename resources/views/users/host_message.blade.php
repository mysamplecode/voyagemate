                ...
                <div class="dialogbox">
                  <div class="body">
                    ...
                    <p class="text-muted">
                      ...
                      <br>
                      {{ trans('messages.message.you_will_get') }} {{ $messages[$i]->bookings->currency->symbol.$messages[$i]->bookings->host_payout }} {{ $messages[$i]->bookings->currency->code }}
                    </p>
                  </div>
                </div>
              </div>
  ...
  <div class="col-md-3 col-sm-3 col-xs-12">
    <div class="panel panel-default row-space-4">
      <div class="mini-profile va-container media panel-body row">
        ...
        <div class="va-middle">
          <div class="h4">
            <a class="text-normal" href="{{ url('/') }}/users/show/{{ $messages[0]->bookings->user_id }}">{{ $messages[0]->bookings->users->first_name }}</a>
