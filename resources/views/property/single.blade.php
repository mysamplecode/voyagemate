          ...
          <div class="margin-top10">
            <form accept-charset="UTF-8" method="post" action="{{ url('payments/book/'.$property_id) }}">
              <div class="col-md-4 col-sm-4 r-pad-none">
                ...
                <div class="">
                  <input class="form-control" id="list_checkin" name="checkin" value="{{ $checkin }}" placeholder="dd-mm-yyyy" type="text" required>
                </div>
              </div>
              ...
              <div class="col-md-4 col-sm-4 r-pad-none">
                ...
                <div class="">
                  <input class="form-control" id="list_checkout" name="checkout" value="{{ $checkout }}" placeholder="dd-mm-yyyy" type="text" required>
                </div>
              </div>
