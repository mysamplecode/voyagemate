...
class Properties extends Model
{
    ...
    public function getOverallRatingAttribute(){
        $reviews = Reviews::where('property_id', $this->attributes['id'])->where('reviwer', 'guest');
    ...
    public function getReviewsCountAttribute(){
        $result = Reviews::where('property_id', $this->attributes['id']);
        return $result->count();
    }
    ...
    public function getCoverPhotoAttribute(){
        ...
        if(isset($cover->photo)) $url = url('public/images/property/'.$this->attributes['id'].'/'.$cover->photo);
        else $url = '';
        return $url;
    }
