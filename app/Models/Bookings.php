...
class Bookings extends Model
{
    ...
    {
      if($this->attributes['status'] == 'Accepted') return 'success';
      else if($this->attributes['status'] == 'Expired') return 'info';
      else if($this->attributes['status'] == 'Declined') return 'info';
      else if($this->attributes['status'] == 'Pending') return 'warning';
      else if($this->attributes['status'] == 'Cancelled') return 'info';
      else if($this->attributes['status'] == '') return 'inquiry';
