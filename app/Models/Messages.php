 ...
 * Messages Model
 *
 * Messages Model manages Messages operation. 
 *
 * @category   Messages
 * @package    vRent
...
class Messages extends Model
{
    ...
    {
        $bookings =  Bookings::where('property_id', $this->attributes['property_id'])->where('host_id', Auth::user()->id )->get();

        if(count($bookings) != 0) return 1;
        else return 0;
    }
