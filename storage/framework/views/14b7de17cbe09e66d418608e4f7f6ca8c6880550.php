      ...
      <div class="col-md-9">
        <div class="row">
          ...
          <div class="col-md-8">
            ...
            <div class="input-addon">
              ...
              <input type="text" data-suggested="" id="price-night" value="<?php echo e((@$result->property_price->original_price == 0) ? '' : @$result->property_price->original_price); ?>" name="price" class="money-input">
            </div>
        ...
        <div class="row <?php echo e((@$result->property_price->weekly_discount == 0 && @$result->property_price->monthly_discount == 0)? 'display-off':''); ?>" id="long-term-div">
          ...
          <div class="col-md-8">
            ...
            <div class="input-addon">
              <!--<span class="input-prefix pay-currency"><?php echo e(@$result->property_price->currency->org_symbol); ?></span>-->
              <input type="text" data-suggested="" id="price-week" value="<?php echo e(@$result->property_price->weekly_discount); ?>" name="weekly_discount" data-saving="long_price" class="money-input">
              <span class="text-danger"><?php echo e($errors->first('weekly_discount')); ?></span>
            </div>
          </div>
          <div class="col-md-8">
            ...
            <div class="input-addon">
              <!--<span class="input-prefix pay-currency"><?php echo e(@$result->property_price->currency->org_symbol); ?></span>-->
              <input type="text" data-suggested="₹16905" id="price-month" class="money-input" value="<?php echo e(@$result->property_price->monthly_discount); ?>" name="monthly_discount" data-saving="long_price">
              <span class="text-danger"><?php echo e($errors->first('monthly_discount')); ?></span>
            </div>
          </div>
        </div>
        <div class="row">
          ...
          <div class="col-md-12">
            <label for="listing_cleaning_fee_native_checkbox" class="label-large label-inline">
              <input type="checkbox" data-extras="true" class="pricing_checkbox" data-rel="cleaning" <?php echo e((@$result->property_price->original_cleaning_fee == 0)?'':'checked="checked"'); ?>>
          ...
          <div class="col-md-12">
            <label for="listing_cleaning_fee_native_checkbox" class="label-large label-inline">
              <input type="checkbox" class="pricing_checkbox" data-rel="additional-guests" <?php echo e(($result->property_price->original_guest_fee == 0)?'':'checked="checked"'); ?>>
          ...
          <div class="col-md-12">
            <label for="listing_cleaning_fee_native_checkbox" class="label-large label-inline">
              <input type="checkbox" class="pricing_checkbox" data-rel="weekend" <?php echo e((@$result->property_price->original_weekend_price == 0)?'':'checked="checked"'); ?>>
        ...
        <div class="row mrg-top-25">
          <div class="col-md-6 text-left">
            <a data-prevent-default="" href="<?php echo e(url('listing/'.@$result->id.'/photos')); ?>" class="btn btn-large btn-primary"><?php echo e(trans('messages.listing_description.back')); ?></a>
          </div>
