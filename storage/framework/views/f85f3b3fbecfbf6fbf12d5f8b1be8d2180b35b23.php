      ...
      <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
        <form action="<?php echo e(url('/')); ?>/s" id="head-form" class="navbar-form navbar-left search-form">
          <div class="form-group sm-dropdown">
            <input type="text" name="location" id="header-search-form" class="form-control" placeholder="<?php echo e(trans('messages.header.where_are_you_going')); ?>" style="width:200px;margin-bottom:1px;">
