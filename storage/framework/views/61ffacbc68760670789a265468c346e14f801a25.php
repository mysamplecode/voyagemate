...
$form_data = [
		...
		'fields' => [
			['type' => 'text', 'class' => 'validate_field', 'label' => 'Name', 'name' => 'name', 'value' => @$result->name],
      		...
      		['type' => 'password', 'class' => 'validate_field', 'label' => 'Password Retype', 'name' => 'password_confirmation', 'value' => '', 'hint' => 'Enter new password only. Leave blank to use existing password.'],
			['type' => 'file', 'class' => 'validate_field', 'label' => 'Photo', 'name' => 'profile_pic', 'value' => ''],
		]
	];
 ?>
