  ...
  <div class="col-md-9">
      <div class="panel panel-default">
        <div class="panel-body h5">
          <?php echo e(trans('messages.account_transaction.transaction')); ?>
          ...
          <div class="panel">
            <div class="panel-body" style="padding: 0px 0px;">
              <table class="table table-bordered">
                <thead>
                  <tr>
                    <th><?php echo e(trans('messages.account_transaction.date')); ?></th>
                    <th><?php echo e(trans('messages.account_transaction.type')); ?></th>
                    <th><?php echo e(trans('messages.account_transaction.detail')); ?></th>
                    <th><?php echo e(trans('messages.account_transaction.amount')); ?></th>
                    <th><?php echo e(trans('messages.account_transaction.status')); ?></th>
                  </tr>
                </thead>
  ...
  function transaction_data_load(page = 1){
      ...
      $.ajax({
        ...
        success: function (result) {
          ...
          for (var key in transaction) {
            if (transaction.hasOwnProperty(key)) {
              ...
              transaction_list += '<tr>'
                                    ...
                                    +'<td>'+"Payout"+'</td>'
                                    +'<td>'+transfer+'</td>'
                                    +'<td><b>'+transaction[key].currency_symbol+' '+transaction[key].amount+'</b></td>'
          ...
          $('#transaction-page-info').html(result.from+' – '+result.to+' of '+result.total+' Transactions');
