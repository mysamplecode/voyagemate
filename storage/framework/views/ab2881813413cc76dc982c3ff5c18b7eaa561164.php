...
<div class="filter-bar">
	<div class="filter-bar-menu">
	    <ul class="nav navbar-nav">
		   <li><a class="active1" href="#"><?php echo e(trans('messages.header.best_photos')); ?></a></li>
  	...
  	<div class="filter-bar__form__filtering">
	  	...
	  	<div class="filter-bar__form__toggle-wrapper">
		  	<div class="radio-wrapper">
			  	<a href="#" class="photo-sale" data-rel="all_photo" data-page="load_best" ><div id="all_photo" class="hide-f pinkColor"><strong><?php echo e(trans('messages.header.all_photos')); ?></strong></div></a>
			  	<a href="#" class="photo-sale" data-rel="sale_photo" data-page="load_best" ><div id="sale_photo" class="hide-f"><strong><?php echo e(trans('messages.header.for_sale')); ?></strong></div></a>
			  	<div class="clearfix"></div>
			</div>
		</div>
	  	<label for="Categories" class="hide-mobile">+</label>
	  	<div class="filter-bar__form__select-wrapper">
		  	<select id="categories" data-rel="load_best" name="tags" class="form-control">
...
<div class="">  
	...
	<div style="text-align:center;margin-bottom:10px;">
		<?php if($photos->count() == 20): ?>
			<button id="load_more" data-rel="load_best" class="btn btn-pinkbg <?php echo e($photos->count() == 20?'':'hide'); ?>"><?php echo e(trans('messages.utility.load_more')); ?></button>
		<?php endif; ?>
	</div>
