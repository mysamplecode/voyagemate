        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              ...
              <div style="float:right;"><a class="btn btn-success" href="<?php echo e(url('admin/add_properties')); ?>">Add Properties</a></div>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
...
<script src="<?php echo e(url('public/backend/dist/js/jquery.dataTables.min.js')); ?>" type="text/javascript">
</script>
