        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              ...
              <?php if(Helpers::has_permission(Auth::guard('admin')->user()->id, 'add_customer')): ?>
                <div style="float:right;"><a class="btn btn-success" href="<?php echo e(url('admin/add_customer')); ?>">Add Customer</a></div>
              <?php endif; ?>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
