        ...
        <form method="post" action="admin/hotel_date_package/" class='form-horizontal' id='dtpc_form'>
          <div class="modal-body">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-6">
                <input type="text" class="form-control date" name="start_date" id='dtpc_start' placeholder = "<?php echo e(trans('messages.listing_calendar.start_date')); ?>" autocomplete = 'off'>
            ...
            <div class="form-group">
              ...
              <div class="col-sm-6">
                <input type="text" class="form-control date" name="end_date" id='dtpc_end' placeholder = "<?php echo e(trans('messages.listing_calendar.end_date')); ?>" autocomplete = 'off'>
