...
<html class="js csstransforms csstransforms3d csstransitions" lang="en">
  <head>
    ...
    <!-- <link href="<?php echo e(url('public/front/css/jquery-ui.css')); ?>" rel="stylesheet" type="text/css" /> -->

    <link href="<?php echo e(url('public/front/js/datepicker/datepicker3.css')); ?>" rel="stylesheet" type="text/css" />
 <!--    <link href="<?php echo e(url('public/front/js/datepicker/jquery-ui-timepicker-addon.css')); ?>" rel="stylesheet" type="text/css" /> -->
