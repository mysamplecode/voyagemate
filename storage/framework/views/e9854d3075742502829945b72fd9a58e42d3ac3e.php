          ...
          <div class="panel-body">
            ...
            <form method="post" action="<?php echo e(url('create')); ?>" class='signup-form login-form' accept-charset='UTF-8'>    
              <div class="row">
                ...
                <!--
                <div class="col-sm-12">
                  <input type='hidden' name='user_profile_info[receive_promotional_email]' value='0'>
                  <input type='checkbox' name='user_profile_info[receive_promotional_email]' value='1' id='user_profile_info_receive_promotional_email'>

                   <?php echo e(trans('messages.sign_up.agree_to')); ?> <?php echo e($site_name); ?>'s <a href="<?php echo e(URL::to('/')); ?>/terms_of_service" data-popup="true"><?php echo e(trans('messages.sign_up.service_term')); ?></a>, <a href="<?php echo e(URL::to('/')); ?>/privacy_policy" data-popup="true"><?php echo e(trans('messages.sign_up.privacy_policy')); ?></a>, <a href="<?php echo e(URL::to('/')); ?>/guest_refund" data-popup="true"><?php echo e(trans('messages.sign_up.refund_policy')); ?></a> <?php echo e(trans('messages.sign_up.and')); ?> <a href="<?php echo e(URL::to('/')); ?>/host_guarantee" data-popup="true"><?php echo e(trans('messages.sign_up.host_guarantee')); ?></a>.
                </div>-->
