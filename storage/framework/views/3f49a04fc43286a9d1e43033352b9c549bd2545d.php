        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <img src="<?php echo e(\Auth::guard('admin')->user()->profile_src); ?>" class="user-image" alt="User Image">
              <span class="hidden-xs"><?php echo e(ucfirst(Auth::guard('admin')->user()->username)); ?></span>
            </a>
            <ul class="dropdown-menu">
              <!-- User image -->
              <li class="user-header">
                <img src="<?php echo e(\Auth::guard('admin')->user()->profile_src); ?>" class="img-circle" alt="User Image">

                <p>
                  <?php echo e(ucfirst(Auth::guard('admin')->user()->username)); ?>

                  <small>Member since <?php echo e(date('M, Y', strtotime(Auth::guard('admin')->user()->created_at))); ?></small>
                </p>
              </li>
              <!-- Menu Body -->
              <!--<li class="user-body">
