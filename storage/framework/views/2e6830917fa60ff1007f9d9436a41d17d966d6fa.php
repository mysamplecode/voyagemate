        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              ...
              <?php if(Helpers::has_permission(Auth::user()->id, 'add_category')): ?>
                <div style="float:right;"><a class="btn btn-success" href="<?php echo e(url('admin/add_category')); ?>">Add Category</a></div>
              <?php endif; ?>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
